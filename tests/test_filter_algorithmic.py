"""Algorithmic filtering tests.

Covers kept code-generation records, removed output-prediction records, and self-repair requirements
so filtering changes do not accidentally widen or narrow the corpus."""
