"""Output comparison rules for execution evaluation.

Supports exact matching, token-normalized matching, case-insensitive matching, and numeric tolerance
so dataset-specific judging behavior can be approximated consistently."""
