"""Local Python execution sandbox for candidate solutions.

Runs generated code in a temporary directory with timeout, output-size, and optional memory limits;
this is designed for controlled evaluation, not for strong adversarial security isolation."""
