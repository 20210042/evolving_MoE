"""Dispatcher and preparation helpers for executable records.

Selects the correct runner from eval_spec, marks unsupported modes clearly, and validates that final
records contain the fields needed by downstream execution workflows."""
...
from acc_data_pipeline.execution.function_call_runner import FunctionCallRunner
from acc_data_pipeline.execution.stdin_stdout_runner import StdinStdoutRunner
