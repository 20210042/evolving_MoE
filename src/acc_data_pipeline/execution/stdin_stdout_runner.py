"""Runner for stdin/stdout programming problems.

Feeds each test input to candidate Python code, compares stdout to expected output using the problem
comparison rule, and returns a normalized execution result."""
...
from acc_data_pipeline.execution.sandbox import run_python_code
