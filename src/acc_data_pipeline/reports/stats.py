"""Report-statistics helpers for pipeline stages.

Computes source counts, split counts, loader warnings, and schema-error aggregates used by the load
and preprocessing reports."""
