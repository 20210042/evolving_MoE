"""CLI for creating the final execution-ready JSONL.

Checks deduplicated records for final required fields, normalizes unsupported evaluation modes, and
writes 04_execution_ready.jsonl with an evaluation-mode report."""
