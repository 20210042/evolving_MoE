"""CLI for algorithmic-task filtering.

Reads normalized JSONL, applies filter_algorithmic rules and optional config overrides, then writes
02_algorithmic_filtered.jsonl plus a removal-reason report."""
