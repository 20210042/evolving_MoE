"""CLI for duplicate and near-duplicate removal.

Reads filtered JSONL, applies configurable deduplication rules, writes 03_deduplicated.jsonl, and
records cluster/removal statistics for auditability."""
