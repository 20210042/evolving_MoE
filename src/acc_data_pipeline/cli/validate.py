"""CLI for schema and final-field validation.

Scans a JSONL file, validates each record against the normalized schema, optionally checks execution-ready
requirements, and writes a machine-readable validation report."""
