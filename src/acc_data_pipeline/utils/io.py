"""Common file IO helpers for pipeline stages.

Handles parent-directory creation, JSON/JSONL reading and writing, tolerant JSON parsing, compact
value conversion, and text reads with replacement for malformed input."""
