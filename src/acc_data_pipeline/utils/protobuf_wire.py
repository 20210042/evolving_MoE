"""Minimal protobuf wire-format reader for CodeContests fallback parsing.

This avoids a hard dependency on generated protobuf classes when only a few primitive fields are
needed from recordio/protobuf payloads."""
