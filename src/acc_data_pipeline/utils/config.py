...
Loads YAML config files when PyYAML is available, falls back to a simple parser otherwise, and
merges user overrides into stage-specific defaults without mutating those defaults."""
