"""Validation helpers for normalized problem records.

Use this module before writing pipeline outputs to catch missing schema fields, invalid enum
values, empty statements, and records that are not ready for execution evaluation."""
