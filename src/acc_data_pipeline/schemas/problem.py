"""Core normalized problem schema shared by every benchmark loader.

This file defines allowed sources, task families, evaluation modes, metadata defaults, and
fallback model behavior so APPS, CodeContests, TACO, and LiveCodeBench records land in one contract."""
