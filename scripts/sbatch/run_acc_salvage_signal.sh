#!/bin/bash
#SBATCH --job-name=acc_salvage_signal
...
# REPORT_task3_task4.md 신호 살리기 검사 (scripts/salvage_signal.py).
#   기존 산출물만 읽는다 — 모델 로드·신규 생성 없음.
# 사용: sbatch scripts/sbatch/run_acc_salvage_signal.sh
...
python scripts/salvage_signal.py
echo "=== done ==="
