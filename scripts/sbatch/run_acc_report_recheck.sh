#!/bin/bash
#SBATCH --job-name=acc_report_recheck
...
# REPORT_task3_task4.md 본문 수치 재검산 (scripts/report_recheck.py).
#   기존 산출물만 읽는다 — 모델 로드·신규 생성 없음.
# 사용: sbatch scripts/sbatch/run_acc_report_recheck.sh
...
python scripts/report_recheck.py
echo "=== done ==="
