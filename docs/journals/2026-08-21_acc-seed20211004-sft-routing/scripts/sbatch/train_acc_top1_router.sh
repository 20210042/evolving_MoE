#!/bin/bash
#SBATCH --job-name=acc_top1_router
...
python "${JOURNAL_DIR}/scripts/router/train_acc_top1_router.py" \
  --output-dir "${ROUTER_DIR:-checkpoints/router/acc_seed20211004_top1_set}" \
