#!/bin/bash
#SBATCH --job-name=acc_soft_router
...
python "${JOURNAL_DIR}/scripts/router/train_acc_soft_router.py" \
  --output-dir "${ROUTER_DIR:-checkpoints/router/acc_seed20211004_soft12}" \
